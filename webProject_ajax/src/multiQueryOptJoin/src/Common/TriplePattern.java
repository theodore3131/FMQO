...
public class TriplePattern implements Comparable<TriplePattern> {
	...
	private boolean subjectVarTag;// subjectVarTag = true means that subject is  variable
	private boolean predicateVarTag;// predicateVarTag = true means that subject  is variable
	private boolean objectVarTag;// objectVarTag = true means that subject is  variable
	...
	public TriplePattern(TriplePattern o) {
		...
		this.signatureStr = o.signatureStr; // 保存 常量
	}
